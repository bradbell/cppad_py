...
.. _mixed_fix_constraint_xam_py.random_effects:
...
.. _mixed_fix_constraint_xam_py.fixed_constraint_bounds:
...
.. _mixed_fix_constraint_xam_py.optimal_fixed_effects:
...
xsrst input file: ``example/python/mixed/fix_constraint_xam.py``
