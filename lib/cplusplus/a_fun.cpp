...
$children%
	lib/example/cplusplus/a_fun_objective_xam.cpp
%$$
$head Example$$
$cref a_fun_objective_xam.cpp$$


$end
*/
std::vector<double> a_fun::objective(const std::vector<double>& x)
{	return ptr_->Forward(int(0), x);
}
/*
------------------------------------------------------------------------------
