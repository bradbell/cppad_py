...
extern bool d_fun_property_xam(void);
extern bool d_fun_optimize_xam(void);
extern bool d_fun_jacobian_xam(void);
extern bool d_fun_hessian_xam(void);
extern bool d_fun_forward_xam(void);
extern bool d_fun_reverse_xam(void);
extern bool d_fun_abort_xam(void);
...
{	bool ok = true;
	...
	ok &= Run( d_fun_property_xam,        "d_fun_property_xam"        );
	ok &= Run( d_fun_optimize_xam,        "d_fun_optimize_xam"        );
	ok &= Run( d_fun_jacobian_xam,        "d_fun_jacobian_xam"        );
	ok &= Run( d_fun_hessian_xam,         "d_fun_hessian_xam"         );
	ok &= Run( d_fun_forward_xam,         "d_fun_forward_xam"         );
	ok &= Run( d_fun_reverse_xam,         "d_fun_reverse_xam"         );
	ok &= Run( d_fun_abort_xam,           "d_fun_abort_xam"           );
