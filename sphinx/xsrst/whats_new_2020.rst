...
.. meta::
   :keywords: previous, years

.. index:: previous, years

.. _whats_new_2020.previous_years:
...
#.  Add a :ref:`install_error.symbolic_link` and
    :ref:`install_error.cppad.pc,_cppad_mixed.pc` entries to the
...
#.  Add an install error entry for when the
    :ref:`cppad_py <install_error.cppad_py>` module can't be found.
...
#.  Add mention of using ``DYLD_LIBRARY_PATH`` in the
    :ref:`libcppad_lib<install_error.libcppad_lib>`
...
:ref:`libcppad_lib<install_error.libcppad_lib>` problem.
...
xsrst input file: ``whats_new/2020.xsrst``
