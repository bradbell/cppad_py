...
.. _mixed_ran_likelihood_xam_py.p(y|theta,_u):
...
.. _mixed_ran_likelihood_xam_py.optimal_fixed_effects:
...
xsrst input file: ``example/python/mixed/ran_likelihood_xam.py``
