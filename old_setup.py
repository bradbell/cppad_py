...
# -----------------------------------------------------------------------------
#
# {xrst_begin_parent old_setup.py}
# {xrst_spell
#     bdist
#     cholmod
#     cmake
...
# see :ref:`old_setup.py.error-name` .
#
#
# Syntax
# ******
...
where *prefix* is the
:ref:`install_settings.py@cmake_install_prefix` in ``bin/get_cppad.sh``.
...
It only happens when :ref:`build_type<install_settings.py@build_type>`
to ``debug`` .
